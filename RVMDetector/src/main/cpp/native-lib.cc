...
extern "C"
JNIEXPORT jint JNICALL Java_com_smartprints_1ksa_battery_1detector_InferenceWrapper_native_1init_1yolo
...
extern "C"
JNIEXPORT void JNICALL Java_com_smartprints_1ksa_battery_1detector_InferenceWrapper_native_1de_1init_1yolo
...
extern "C"
JNIEXPORT jint JNICALL Java_com_smartprints_1ksa_battery_1detector_InferenceWrapper_native_1run_1yolo
...
Java_com_smartprints_1ksa_battery_1detector_InferenceWrapper_native_1post_1process_1yolo(JNIEnv *env, jobject thiz,
	...
	detect_counts = post_process((char *)grid0_buf, (char *)grid1_buf, (char *)grid2_buf,
...
//extern "C"
//JNIEXPORT jlong JNICALL Java_com_smartprints_1ksa_battery_1detector_tracker_ObjectTracker_native_1create
//                                                            (JNIEnv * env, jobject obj) {
//    return create_tracker();
//}
//
//extern "C"
//JNIEXPORT void JNICALL Java_com_smartprints_1ksa_battery_1detector_tracker_ObjectTracker_native_1destroy
//                                                            (JNIEnv * env, jobject obj,
//                                                            jlong handle) {
...
extern "C"
JNIEXPORT void JNICALL Java_com_smartprints_1ksa_battery_1detector_tracker_ObjectTracker_native_1track
                                                            (JNIEnv * env, jobject obj,
                                                                  jlong handle,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_smartprints_1ksa_battery_1detector_rga_RGA_color_1convert_1and_1flip(JNIEnv *env, jclass clazz,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_smartprints_1ksa_battery_1detector_InferenceWrapper_native_1init_1classifier(JNIEnv *env,
																			jobject thiz,
																			jint im_height,
																			jint im_width,
																			jint im_channel,
																			jstring model_path) {
	char *model_path_c = jstringToChar(env, model_path);
	return create_model(im_height, im_width, im_channel, model_path_c);
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_smartprints_1ksa_battery_1detector_InferenceWrapper_native_1run_1classifier(JNIEnv *env,
																		   jobject thiz,
																		   jbyteArray in_data,
																		   jfloatArray out_data) {

	jboolean inputCopy = JNI_FALSE;
	jbyte* const inData = env->GetByteArrayElements(in_data, &inputCopy);

	jboolean outputCopy = JNI_FALSE;

	jfloat* const y = env->GetFloatArrayElements(out_data, &outputCopy);

	run_model((char *)inData, (float *)y);

	env->ReleaseByteArrayElements(in_data, inData, JNI_ABORT);
	env->ReleaseFloatArrayElements(out_data, y, 0);
