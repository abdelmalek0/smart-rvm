...
int post_process(char *grid0_buf, char *grid1_buf, char *grid2_buf,
...
//    LOGI("start yolo post.");
    ret = post_process((float *)grid0_buf, (float *)grid1_buf, (float *)grid2_buf,
